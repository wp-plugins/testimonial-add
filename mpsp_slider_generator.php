...
<div id='tss_warppper'>
  <div id='tss_content'>
    <img id='tss_image' src="<?php echo get_post_meta($id,'tss_image',true);  ?>">
    <p class='tss_p' id='tss_name'><?php echo get_post_meta($id,'tss_name',true);  ?></p>
    <p class='tss_p' id='tss_occupation'><?php echo get_post_meta($id,'tss_ocupation',true);  ?></p>
    <p class='tss_p' id='tss_testimonial'><span>"</span><?php echo get_post_meta($id,'tss_testimonial',true);  ?><span>"</span></p>
  </div>  
</div>
