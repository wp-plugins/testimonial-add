...
>Slug</option>
      ...
      <input type="radio" name="mpsp_slide_layout_custom" id='mpsp_layout_1' value="templates/mpsp_slider_generator.php" style="width:15px;"  <?php checked( "templates/mpsp_slider_generator.php", $mpsp_slide_layout_custom ); ?>
   checked >
      <br>

      <label for="mpsp_layout_2"><img src="<?php echo plugins_url('img/Temp-2.png',__FILE__); ?>" width="200px" ></label>
      <input type="radio" name="mpsp_slide_layout_custom" id='mpsp_layout_2'  value='templates/mpsp_slider_generator_1.php' style="width:15px;"

<?php checked( "templates/mpsp_slider_generator_1.php", $mpsp_slide_layout_custom ); ?>
      >
          <br>
      ...
      value='templates/mpsp_slider_generator_2.php'style="width:15px;" selected     
<?php checked( "templates/mpsp_slider_generator_2.php", $mpsp_slide_layout_custom ); ?>
      >
          <br>
          <br>
