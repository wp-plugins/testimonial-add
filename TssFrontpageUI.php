...
$pss = 'posts-slider';
	...
	?>
		...
		<h1>Testimonial Slider Plugin</h1>
		<div id='sec_left'>
			<br>
			<br>
			...
			<br>
			<br>
			<a  style='background:#A5D27D; color:#fff; text-decoration:none;padding:15px; border-bottom:10px solid #75ad41;' 
			href="edit.php?post_type=tss_data"> All Testimonials </b></a>
			<br>
			<br>
			<br>
			<br>
			<a  style='background:#A5D27D; color:#fff; text-decoration:none;padding:15px; border-bottom:10px solid #75ad41;' 
			href="post-new.php?post_type=tss_data"> Add New Testimonial </b></a>
			</div>
		<div id='sec_right'>
				...
				<p>Need Help ? <br> Or Hire us : <a href="mailto:support@web-settler.com?subject=Posts Slider Support" "Email Us" target="_blank">Email Us</a> </p>
				</b>
		</div>
